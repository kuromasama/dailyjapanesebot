...
**這是 v0.21-v0.23 引入的重大升級。** 你的「閱讀（輸入）」與「寫作（輸出）」能力現在被分開評估。
...
* **🔥 價值觀進化：追求「道地日文」 (v0.24)**: 
    * AI 的核心目標已從「抓出文法對錯」進化為**「追求像日本人一樣說話 (Natural Native Japanese)」**。
    * **中翻日**：AI 現在能分辨真正的**「文法錯誤 (Mistake)」**與**「風格語感 (Nuance)」**。若你使用 `コーヒー屋` 這種道地的口語，AI 不但不會判錯，反而會**給予高度讚賞**，並告訴你這在什麼場合適用。
